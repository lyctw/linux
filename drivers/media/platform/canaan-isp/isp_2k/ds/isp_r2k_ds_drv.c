...
*
*/
static void Isp_Drv_R2k_Ds_SetHscaleParam(struct k510_isp_device *isp,unsigned char Index,ISP_DS_HSCALE_PARM_S *Hscale)
{
	if(Index == 0)
	{
...
*
*/
static void Isp_Drv_R2k_Ds_SetVscaleParam(struct k510_isp_device *isp,unsigned char Index, ISP_DS_VSCALE_PARM_S *Vscale)
{
	if(Index == 0)
	{
...
static void Isp_Drv_R2k_Ds_SetDs0OsdAttr(struct k510_isp_device *isp,unsigned char OsdIndex,ISP_DS_OSD_ATTR_S *OsdAttr)
{
    if(OsdIndex == 0)
    {
...
static void Isp_Drv_R2k_Ds_SetDs1OsdAttr(struct k510_isp_device *isp,unsigned char OsdIndex,ISP_DS_OSD_ATTR_S *OsdAttr)
{
...
static void Isp_Drv_R2k_Ds_SetDs2OsdAttr(struct k510_isp_device *isp,unsigned char OsdIndex,ISP_DS_OSD_ATTR_S *OsdAttr)
{
...
*
*/
void Isp_Drv_R2k_Ds_SetSingleDS(struct k510_isp_device *isp,unsigned char Index,ISP_S_DS_ATTR_S *stDsAttr)
{
