...
void Isp_Drv_F2k_Ds_SetInputSize(struct k510_isp_device *isp,IMAGE_SIZE *inputsize)
{
	...
	union U_ISP_DS_INPUT_SIZE udata;
	udata.u32 = 0;
...
void Isp_Drv_F2k_Ds_SetRgb2YuvCoff(struct k510_isp_device *isp,unsigned int *osd_rgb2yuv_coeff)
{
	...
	unsigned int i = 0;
	union U_ISP_DS_OSD_RGB2YUV_COEFF stCoff;
	for(i = 0; i< 12; i++)
	{
		stCoff.u32 = 0;
...
void Isp_Drv_F2k_Ds_SetYuv2RgbCoff(struct k510_isp_device *isp,unsigned int *osd_yuv2rgb_coeff)
{
	...
	unsigned int i = 0;
	union U_ISP_DS_OSD_YUV2RGB_COEFF stCoff;
	for(i = 0; i< 12; i++)
	{
		stCoff.u32 = 0;
...
*
*/
static void Isp_Drv_F2k_Ds_SetHscaleParam(struct k510_isp_device *isp,unsigned char Index,ISP_DS_HSCALE_PARM_S *Hscale)
{

	if(Index == 0)
	{
        union U_ISP_DS0_HSCALE_PARM stDs0;
		stDs0.u32 = 0;
		stDs0.bits.ds0_hscale_dstep = Hscale->hscale_dstep;
		stDs0.bits.ds0_hscale_pstep = Hscale->hscale_pstep;
		stDs0.bits.ds0_hscale_filter_en = 1;//Hscale->hscale_filter_en;
		isp_reg_writel(isp,stDs0.u32,ISP_IOMEM_F2K_DS,ISP_DS0_HSCALE_PARM);
	}
	
	if(Index == 1)
	{
	    union U_ISP_DS1_HSCALE_PARM stDs1;	
		stDs1.u32 = 0;
	...
	if(Index == 2)
	{
        union U_ISP_DS2_HSCALE_PARM stDs2;
		stDs2.u32 = 0;
...
*
*/
static void Isp_Drv_F2k_Ds_SetVscaleParam(struct k510_isp_device *isp,unsigned char Index, ISP_DS_VSCALE_PARM_S *Vscale)
{

	if(Index == 0)
	{
		union U_ISP_DS0_VSCALE_PARM stDs0;
		stDs0.u32 = 0;
		stDs0.bits.ds0_vscale_dstep = Vscale->vscale_dstep;
		stDs0.bits.ds0_vscale_pstep = Vscale->vscale_pstep;
		stDs0.bits.ds0_vscale_filter_en = 1;//Vscale->vscale_filter_en;
		stDs0.bits.ds0_scale_en = 1;//Vscale->scale_en;
		isp_reg_writel(isp,stDs0.u32,ISP_IOMEM_F2K_DS,ISP_DS0_VSCALE_PARM);
	}
	
	if(Index == 1)
	{
		union U_ISP_DS1_VSCALE_PARM stDs1;
		stDs1.u32 = 0;
	...
	if(Index == 2)
	{
		union U_ISP_DS2_VSCALE_PARM stDs2;
		stDs2.u32 = 0;
...
static void Isp_Drv_F2k_Ds_SetDs0OsdAttr(struct k510_isp_device *isp,unsigned char OsdIndex,ISP_DS_OSD_ATTR_S *OsdAttr)
{

    if(OsdIndex == 0)
    {
    	union U_ISP_DS0_OSD0_INFO stOsd0Info;
        stOsd0Info.u32 = 0;
    	...
    	union U_ISP_DS0_OSD0_SIZE stOsd0Size;      
        stOsd0Size.u32 = 0;
    	...
    	union U_ISP_DS0_OSD0_BUF_ADDR0 stOsd0Addr0;        
        stOsd0Addr0.u32 = 0;
    	...
    	union U_ISP_DS0_OSD0_BUF_ADDR1 stOsd0Addr1;  
        stOsd0Addr1.u32 = 0;
    	...
    	union U_ISP_DS0_OSD0_ALPHA_BUF_ADDR0 stOsd0AlphaAddr0;      
    	...
    	union U_ISP_DS0_OSD0_ALPHA_BUF_ADDR1 stOsd0AlphaAddr1;
    	...
    	union U_ISP_DS0_OSD0_DMA_CTL stOsd0DmaCtl;  
        stOsd0DmaCtl.u32 = 0;
    	...
    	union U_ISP_DS0_OSD0_STRIDE stOsd0Stride;  
        stOsd0Stride.u32 = 0;
    	...
    	union U_ISP_DS0_OSD0_X_RANGE stOsd0XRange;
        stOsd0XRange.u32 = 0;
    	...
    	union U_ISP_DS0_OSD0_Y_RANGE stOsd0YRange;
        stOsd0YRange.u32 = 0;
    ...
    if(OsdIndex == 1)
    {
    	union U_ISP_DS0_OSD1_INFO stOsd1Info;
        stOsd1Info.u32 = 0;
    	...
    	union U_ISP_DS0_OSD1_SIZE stOsd1Size;  
        stOsd1Size.u32 = 0;
    	...
    	union U_ISP_DS0_OSD1_BUF_ADDR0 stOsd1Addr0;   
        stOsd1Addr0.u32 = 0;
        ...
        union U_ISP_DS0_OSD1_BUF_ADDR1 stOsd1Addr1;
        stOsd1Addr1.u32 = 0;
    	...
    	union U_ISP_DS0_OSD1_ALPHA_BUF_ADDR0 stOsd1AlphaAddr0;   
    	...
    	union U_ISP_DS0_OSD1_ALPHA_BUF_ADDR1 stOsd1AlphaAddr1;
    	...
    	union U_ISP_DS0_OSD1_DMA_CTL stOsd1DmaCtl;   
        stOsd1DmaCtl.u32 = 0;
        ...
        union U_ISP_DS0_OSD1_STRIDE stOsd1Stride;
        stOsd1Stride.u32 = 0;
	    ...
	    union U_ISP_DS0_OSD1_X_RANGE stOsd1XRange;
        stOsd1XRange.u32 = 0;
        ...
        union U_ISP_DS0_OSD1_Y_RANGE stOsd1YRange;
        stOsd1YRange.u32 = 0;
    ...
    if(OsdIndex == 2)
    {
    	union U_ISP_DS0_OSD2_INFO stOsd2Info; 
        stOsd2Info.u32 = 0;
    	...
    	union U_ISP_DS0_OSD2_SIZE stOsd2Size; 
        stOsd2Size.u32 = 0;
    	...
    	union U_ISP_DS0_OSD2_BUF_ADDR0 stOsd2Addr0;
        stOsd2Addr0.u32 = 0;
        ...
        union U_ISP_DS0_OSD2_BUF_ADDR1 stOsd2Addr1;
        stOsd2Addr1.u32 = 0;
    	...
    	union U_ISP_DS0_OSD2_ALPHA_BUF_ADDR0 stOsd2AlphaAddr0; 
    	...
    	union U_ISP_DS0_OSD2_ALPHA_BUF_ADDR1 stOsd2AlphaAddr1;
    	...
    	union U_ISP_DS0_OSD2_DMA_CTL stOsd2DmaCtl;
        stOsd2DmaCtl.u32 = 0;
    	...
    	union U_ISP_DS0_OSD2_STRIDE stOsd2Stride;
        stOsd2Stride.u32 = 0;
	    ...
	    union U_ISP_DS0_OSD2_X_RANGE stOsd2XRange;
        stOsd2XRange.u32 = 0;
    	...
    	union U_ISP_DS0_OSD2_Y_RANGE stOsd2YRange; 
        stOsd2YRange.u32 = 0;
...
static void Isp_Drv_F2k_Ds_SetDs1OsdAttr(struct k510_isp_device *isp,unsigned char OsdIndex,ISP_DS_OSD_ATTR_S *OsdAttr)
{
    if(OsdIndex == 0)
    {
    	union U_ISP_DS1_OSD0_INFO stOsd0Info;
        stOsd0Info.u32 = 0;
    	...
    	union U_ISP_DS1_OSD0_SIZE stOsd0Size;   
        stOsd0Size.u32 = 0;
    	...
    	union U_ISP_DS1_OSD0_BUF_ADDR0 stOsd0Addr0; 
        stOsd0Addr0.u32 = 0;
    	...
    	union U_ISP_DS1_OSD0_BUF_ADDR1 stOsd0Addr1; 
        stOsd0Addr1.u32 = 0;
        ...
        union U_ISP_DS1_OSD0_ALPHA_BUF_ADDR0 stOsd0AlphaAddr0;    	
        stOsd0AlphaAddr0.u32 = 0;
    	...
    	union U_ISP_DS1_OSD0_ALPHA_BUF_ADDR1 stOsd0AlphaAddr1;
        stOsd0AlphaAddr1.u32 = 0;
    	...
    	union U_ISP_DS1_OSD0_DMA_CTL stOsd0DmaCtl;   
        stOsd0DmaCtl.u32 = 0;
    	...
    	union U_ISP_DS1_OSD0_STRIDE stOsd0Stride;
        stOsd0Stride.u32 = 0;
    	...
    	union U_ISP_DS1_OSD0_X_RANGE stOsd0XRange;	
        stOsd0XRange.u32 = 0;
        ...
        union U_ISP_DS1_OSD0_Y_RANGE stOsd0YRange;
        stOsd0YRange.u32 = 0;
    ...
    if(OsdIndex == 1)
    {
    	union U_ISP_DS1_OSD1_INFO stOsd1Info;
        stOsd1Info.u32 = 0;
    	...
    	union U_ISP_DS1_OSD1_SIZE stOsd1Size;  
        stOsd1Size.u32 = 0;
    	...
    	union U_ISP_DS1_OSD1_BUF_ADDR0 stOsd1Addr0;
        stOsd1Addr0.u32 = 0;
    	...
    	union U_ISP_DS1_OSD1_BUF_ADDR1 stOsd1Addr1;
        stOsd1Addr1.u32 = 0;
        ...
        union U_ISP_DS1_OSD1_ALPHA_BUF_ADDR0 stOsd1AlphaAddr0;     
        stOsd1AlphaAddr0.u32 = 0;
	    ...
	    union U_ISP_DS1_OSD1_ALPHA_BUF_ADDR1 stOsd1AlphaAddr1;
        stOsd1AlphaAddr1.u32 = 0;
    	...
    	union U_ISP_DS1_OSD1_DMA_CTL stOsd1DmaCtl;   
        stOsd1DmaCtl.u32 = 0;
    	...
    	union U_ISP_DS1_OSD1_STRIDE stOsd1Stride;    
        stOsd1Stride.u32 = 0;
    	...
    	union U_ISP_DS1_OSD1_X_RANGE stOsd1XRange;
        stOsd1XRange.u32 = 0;
    	...
    	union U_ISP_DS1_OSD1_Y_RANGE stOsd1YRange;     
        stOsd1YRange.u32 = 0;
    ...
    if(OsdIndex == 2)
    {
    	union U_ISP_DS1_OSD2_INFO stOsd2Info;
        stOsd2Info.u32 = 0;
    	...
    	union U_ISP_DS1_OSD2_SIZE stOsd2Size;
        stOsd2Size.u32 = 0;
    	...
    	union U_ISP_DS1_OSD2_BUF_ADDR0 stOsd2Addr0;  
        stOsd2Addr0.u32 = 0;
    	...
    	union U_ISP_DS1_OSD2_BUF_ADDR1 stOsd2Addr1;     
        stOsd2Addr1.u32 = 0;
    	...
    	union U_ISP_DS1_OSD2_ALPHA_BUF_ADDR0 stOsd2AlphaAddr0;
        stOsd2AlphaAddr0.u32 = 0;
    	...
    	union U_ISP_DS1_OSD2_ALPHA_BUF_ADDR1 stOsd2AlphaAddr1;
        stOsd2AlphaAddr1.u32 = 0;
    	...
    	union U_ISP_DS1_OSD2_DMA_CTL stOsd2DmaCtl;   
        stOsd2DmaCtl.u32 = 0;
    	...
    	union U_ISP_DS1_OSD2_STRIDE stOsd2Stride;
        stOsd2Stride.u32 = 0;
	    ...
	    union U_ISP_DS1_OSD2_X_RANGE stOsd2XRange;
        stOsd2XRange.u32 = 0;
    	...
    	union U_ISP_DS1_OSD2_Y_RANGE stOsd2YRange; 
        stOsd2YRange.u32 = 0;
...
static void Isp_Drv_F2k_Ds_SetDs2OsdAttr(struct k510_isp_device *isp,unsigned char OsdIndex,ISP_DS_OSD_ATTR_S *OsdAttr)
{

    if(OsdIndex == 0)
    {
	    union U_ISP_DS2_OSD0_INFO stOsd0Info;
        stOsd0Info.u32 = 0;
    	...
    	union U_ISP_DS2_OSD0_SIZE stOsd0Size; 
        stOsd0Size.u32 = 0;
    	...
    	union U_ISP_DS2_OSD0_BUF_ADDR0 stOsd0Addr0;    
        stOsd0Addr0.u32 = 0;
    	...
    	union U_ISP_DS2_OSD0_BUF_ADDR1 stOsd0Addr1;    	   
        stOsd0Addr1.u32 = 0;
        ...
        union U_ISP_DS2_OSD0_ALPHA_BUF_ADDR0 stOsd0AlphaAddr0;   
        stOsd0AlphaAddr0.u32 = 0;
    	...
    	union U_ISP_DS2_OSD0_ALPHA_BUF_ADDR1 stOsd0AlphaAddr1;
        stOsd0AlphaAddr1.u32 = 0;
    	...
    	union U_ISP_DS2_OSD0_DMA_CTL stOsd0DmaCtl;
        stOsd0DmaCtl.u32 = 0;
    	...
    	union U_ISP_DS2_OSD0_STRIDE stOsd0Stride;
        stOsd0Stride.u32 = 0;
    	...
    	union U_ISP_DS2_OSD0_X_RANGE stOsd0XRange;
        stOsd0XRange.u32 = 0;
    	...
    	union U_ISP_DS2_OSD0_Y_RANGE stOsd0YRange;    
        stOsd0YRange.u32 = 0;
    ...
    if(OsdIndex == 1)
    {
    	union U_ISP_DS2_OSD1_INFO stOsd1Info;
        stOsd1Info.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_SIZE stOsd1Size; 
        stOsd1Size.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_BUF_ADDR0 stOsd1Addr0;  
        stOsd1Addr0.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_BUF_ADDR1 stOsd1Addr1;     
        stOsd1Addr1.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_ALPHA_BUF_ADDR0 stOsd1AlphaAddr0; 
        stOsd1AlphaAddr0.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_ALPHA_BUF_ADDR1 stOsd1AlphaAddr1;
        stOsd1AlphaAddr1.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_DMA_CTL stOsd1DmaCtl;     
        stOsd1DmaCtl.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_STRIDE stOsd1Stride;  
        stOsd1Stride.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_X_RANGE stOsd1XRange;
        stOsd1XRange.u32 = 0;
    	...
    	union U_ISP_DS2_OSD1_Y_RANGE stOsd1YRange;     
        stOsd1YRange.u32 = 0;
    ...
    if(OsdIndex == 2)
    {
    	union U_ISP_DS2_OSD2_INFO stOsd2Info;
        stOsd2Info.u32 = 0;
    	...
    	union U_ISP_DS2_OSD2_SIZE stOsd2Size; 
        stOsd2Size.u32 = 0;
    	...
    	union U_ISP_DS2_OSD2_BUF_ADDR0 stOsd2Addr0;   
        stOsd2Addr0.u32 = 0;
    	...
    	union U_ISP_DS2_OSD2_BUF_ADDR1 stOsd2Addr1; 
        stOsd2Addr1.u32 = 0;
    	...
    	union U_ISP_DS2_OSD2_ALPHA_BUF_ADDR0 stOsd2AlphaAddr0; 
        stOsd2AlphaAddr0.u32 = 0;
    	...
    	union U_ISP_DS2_OSD2_ALPHA_BUF_ADDR1 stOsd2AlphaAddr1;
        stOsd2AlphaAddr1.u32 = 0;
    	...
    	union U_ISP_DS2_OSD2_DMA_CTL stOsd2DmaCtl;  
        stOsd2DmaCtl.u32 = 0;
    	...
    	union U_ISP_DS2_OSD2_STRIDE stOsd2Stride;   
        stOsd2Stride.u32 = 0;
    	...
    	union U_ISP_DS2_OSD2_X_RANGE stOsd2XRange;
        stOsd2XRange.u32 = 0;
        ...
        union U_ISP_DS2_OSD2_Y_RANGE stOsd2YRange; 
        stOsd2YRange.u32 = 0;
...
*
*/
void Isp_Drv_F2k_Ds_SetSingleDS(struct k510_isp_device *isp,unsigned char Index,ISP_S_DS_ATTR_S *stDsAttr)
{
    ...
    IMAGE_SIZE *DsSize = &stDsAttr->dsOutSize;
