...
{
	union U_ISP_WRAP_SWRST_CTL stData;
	stData.u32 = 0;
...
{
	union U_ISP_WRAP_DMA_SWRST_CTL stData;	
	stData.u32 = 0;
...
int Isp_Drv_R2k_Wrap_SetModeCtl_OutSel(struct k510_isp_device *isp,unsigned int external_out_ch_sel)
{
	...
	union U_ISP_WRAP_CTL_MODE stData;
...
static int Isp_Drv_R2k_Wrap_SetModeCtl_Wdr(struct k510_isp_device *isp,ISP_WRAP_WDR_MODE_CTL_S *pstWdrModeCtl)
{
...
int Isp_Drv_R2k_Wrap_SetModeCtl_3dnr_fbcd_en(struct k510_isp_device *isp,unsigned int nr3d_fbcd_en)
{
...
int Isp_Drv_R2k_Wrap_SetModeCtl_3dnr_mv_en(struct k510_isp_device *isp,unsigned int nr3d_mv_out_en)
{
...
{
	union U_ISP_WRAP_PIPE_CLK_CTL stData;	
...
static void Isp_Drv_R2k_Wrap_Set3DnrClkCtl(struct k510_isp_device *isp,signed int clk_3dnr_en)
{
...
static void Isp_Drv_R2k_Wrap_SetWdrClkCtl(struct k510_isp_device *isp,ISP_WRAP_WDR_CLK_CTL_S *pstWdrClkCtl)
{
	union U_ISP_WRAP_PIPE_CLK_CTL stData;	
	stData.u32 = isp_reg_readl(isp,ISP_IOMEM_R2K_WRAP,ISP_WRAP_PIPE_CLK_CTL);
...
static void Isp_Drv_R2k_Wrap_SetLdcClkCtl(struct k510_isp_device *isp,unsigned int ldc_clk_en)
{
...
static void Isp_Drv_R2k_Wrap_SetMainClkCtl(struct k510_isp_device *isp,unsigned int main_out_clk_en)
{
...
static void Isp_Drv_R2k_Wrap_SetDs0ClkCtl(struct k510_isp_device *isp,ISP_WRAP_DS0_CLK_CTL_S *pstDs0ClkCtl)
{
...
static void Isp_Drv_R2k_Wrap_SetDs1ClkCtl(struct k510_isp_device *isp,ISP_WRAP_DS1_CLK_CTL_S *pstDs1ClkCtl)
{
...
static void Isp_Drv_R2k_Wrap_SetDs2ClkCtl(struct k510_isp_device *isp,ISP_WRAP_DS2_CLK_CTL_S *pstDs2ClkCtl)
{
...
*DMA EN
*/
static void Isp_Drv_R2k_Wrap_Set3dnrDmaEnCtl(struct k510_isp_device *isp,unsigned int pipe_3dnr_dma_en)
{	
	

	union U_ISP_WRAP_DMA_EN_CTL stData;	
...
static void Isp_Drv_R2k_Wrap_SetWdrDmaEnCtl(struct k510_isp_device *isp,ISP_WRAP_WDR_DMA_EN_CTL_S *pstWdrDmaEn)
{
...
static void Isp_Drv_R2k_Wrap_SetLdcDmaEnCtl(struct k510_isp_device *isp,unsigned int ldc_dma_en)
{
...
static void Isp_Drv_R2k_Wrap_SetMainDmaEnCtl(struct k510_isp_device *isp,unsigned int main_out_dma_en)
{
...
static void Isp_Drv_R2k_Wrap_SetDs0DmaEnCtl(struct k510_isp_device *isp,ISP_WRAP_DS0_DMA_EN_CTL_S *pstDs0DMAEnCtl)
{

	union U_ISP_WRAP_DMA_EN_CTL stData;	
	stData.u32 = isp_reg_readl(isp,ISP_IOMEM_R2K_WRAP,ISP_WRAP_DMA_EN_CTL);
	stData.bits.ds_out0_dma_en = 1;//pstDs0DMAEnCtl->ds_out0_dma_en;
    stData.bits.ds_out0_y_ch_dma_en = 1;//pstDs0DMAEnCtl->ds_out0_y_ch_dma_en; 
    stData.bits.ds_out0_uv_ch_dma_en = 1;//pstDs0DMAEnCtl->ds_out0_uv_ch_dma_en;
...
static void Isp_Drv_R2k_Wrap_SetDs1DmaEnCtl(struct k510_isp_device *isp,ISP_WRAP_DS1_DMA_EN_CTL_S *pstDs1DMAEnCtl)
{
...
static void Isp_Drv_R2k_Wrap_SetDs2DmaEnCtl(struct k510_isp_device *isp,ISP_WRAP_DS2_DMA_EN_CTL_S *pstDs2DMAEnCtl)
{	
...
*3dnr format
*/
static int Isp_Drv_R2k_Wrap_Set3DnrFormatCtl(struct k510_isp_device *isp,ISP_WRAP_3DNR_PIXEL_FORMAT_CTL_S *pst3DnrFormat)
{

    union U_ISP_WRAP_3DNR_WDR_FORMAT_CTL stData;
...
*WDR
*/
static int Isp_Drv_R2k_Wrap_SetWdrFormatCtl(struct k510_isp_device *isp,ISP_WRAP_WDR_PIXEL_FORMAT_CTL_S *pstWdrFormat)
{
    union U_ISP_WRAP_3DNR_WDR_FORMAT_CTL stData;
	stData.u32 = isp_reg_readl(isp,ISP_IOMEM_R2K_WRAP,ISP_WRAP_3DNR_WDR_FORMAT_CTL);
...
*DS pixel format
*/
static int Isp_Drv_R2k_Wrap_SetMainPixelFormatCtl(struct k510_isp_device *isp,ISP_WRAP_MAIN_PIXEL_FORMAT_CTL_S *pstMainPixelFormat)
{
	union U_ISP_WRAP_PIXEL_FORMAT_CTL stData;
...
static int Isp_Drv_R2k_Wrap_SetDs0PixelFormatCtl(struct k510_isp_device *isp,ISP_WRAP_DS0_PIXEL_FORMAT_CTL_S *pstDs0PixelFormat)
{
...
static int Isp_Drv_R2k_Wrap_SetDs1PixelFormatCtl(struct k510_isp_device *isp,ISP_WRAP_DS1_PIXEL_FORMAT_CTL_S *pstDs1PixelFormat)
{
...
static int Isp_Drv_R2k_Wrap_SetDs2PixelFormatCtl(struct k510_isp_device *isp,ISP_WRAP_DS2_PIXEL_FORMAT_CTL_S *pstDs2PixelFormat)
{
...
*DS out size
*/
static int Isp_Drv_R2k_Wrap_SetMainOutSize(struct k510_isp_device *isp,ISP_WRAP_MAIN_OUT_SIZE_S *stMainOutSize)
{
	
	union U_ISP_WRAP_MAIN_OUT_SIZE stMainData;
	stMainData.u32 = 0;
...
static int Isp_Drv_R2k_Wrap_SetDs0OutSize(struct k510_isp_device *isp,ISP_WRAP_DS0_OUT_SIZE_S *stDs0OutSize)
{

	union U_ISP_WRAP_DS0_OUT_SIZE stDS0Data;
	stDS0Data.u32 = 0;
...
static int Isp_Drv_R2k_Wrap_SetDs1OutSize(struct k510_isp_device *isp,ISP_WRAP_DS1_OUT_SIZE_S *stDs1OutSize)
{

	union U_ISP_WRAP_DS1_OUT_SIZE stDS1Data;
	stDS1Data.u32 = 0;
...
static int Isp_Drv_R2k_Wrap_SetDs2OutSize(struct k510_isp_device *isp,ISP_WRAP_DS2_OUT_SIZE_S *stDs2OutSize)
{
	union U_ISP_WRAP_DS2_OUT_SIZE stDS2Data;
	stDS2Data.u32 = 0;
...
*DMA
 */
static int Isp_Drv_R2k_Wrap_SetDmaMode(struct k510_isp_device *isp,ISP_WRAP_DMA_MODE_S *pstDmaMode)
{
	union U_ISP_WRAP_DMA_ARB_MODE stArbMode;
	stArbMode.u32 = 0;
	...
	union U_ISP_WRAP_DMA_WR_WEIGHT_0 stWrWeight0;
	stWrWeight0.u32 = 0;
	...
	union U_ISP_WRAP_DMA_WR_WEIGHT_1 stWrWeight1;
	stWrWeight1.u32 = 0;
	...
	union U_ISP_WRAP_DMA_WR_WEIGHT_2 stWrWeight2;
	stWrWeight2.u32 = 0;
	...
	union U_ISP_WRAP_DMA_WR_WEIGHT_3 stWrWeight3;
	stWrWeight3.u32 = 0;
	...
	union U_ISP_WRAP_DMA_RD_WEIGHT_0 stRdWeight0;
	stRdWeight0.u32 = 0;
	...
	union U_ISP_WRAP_DMA_RD_WEIGHT_1 stRdWeight1;
	stRdWeight1.u32 = 0;
	...
	union U_ISP_WRAP_DMA_RD_WEIGHT_2 stRdWeight2;
	stRdWeight2.u32 = 0;
	...
	union U_ISP_WRAP_DMA_RD_WEIGHT_3 stRdWeight3;
	stRdWeight3.u32 = 0;
	...
	union U_ISP_WRAP_DMA_WR_PRIORITY_0 stWrPriority0;
	stWrPriority0.u32 = 0;
	...
	union U_ISP_WRAP_DMA_WR_PRIORITY_1 stWrPriority1;
	stWrPriority1.u32 = 0;
	...
	union U_ISP_WRAP_DMA_RD_PRIORITY_0 stRdPriority0;
	stRdPriority0.u32 = 0;
	...
	union U_ISP_WRAP_DMA_RD_PRIORITY_1 stRdPriority1;
	stRdPriority1.u32 = 0;
	...
	union U_ISP_DMA_WR_CH_ID_0 stWrChId0;
	stWrChId0.u32 = 0;
	...
	union U_ISP_DMA_WR_CH_ID_1 stWrChId1;
	stWrChId1.u32 = 0;
	...
	union U_ISP_DMA_RD_CH_ID_0 stRdChId0;
	stRdChId0.u32 = 0;
	...
	union U_ISP_DMA_RD_CH_ID_1 stRdChId1;
	stRdChId1.u32 = 0;
...
static int Isp_Drv_R2k_Wrap_SetDmaCfgMode(struct k510_isp_device *isp,ISP_WRAP_DMA_CFG_S *pstDmaCfg)
{

	union U_ISP_WRAP_DMA_CH0_CFG stDmaCfg0;
	stDmaCfg0.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH1_CFG stDmaCfg1;
	stDmaCfg1.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH2_CFG stDmaCfg2;
	stDmaCfg2.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH3_CFG stDmaCfg3;
	stDmaCfg3.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH4_CFG stDmaCfg4;
	stDmaCfg4.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH5_CFG stDmaCfg5;
	stDmaCfg5.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH6_CFG stDmaCfg6;
	stDmaCfg6.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH7_CFG stDmaCfg7;
	stDmaCfg7.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH8_CFG stDmaCfg8;
	stDmaCfg8.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH9_CFG stDmaCfg9;
	stDmaCfg9.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH10_CFG stDmaCfg10;
	stDmaCfg10.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH11_CFG stDmaCfg11;
	stDmaCfg11.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH12_CFG stDmaCfg12;
	stDmaCfg12.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH13_CFG stDmaCfg13;
	stDmaCfg13.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH14_CFG stDmaCfg14;
	stDmaCfg14.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH15_CFG stDmaCfg15;	
	stDmaCfg15.u32 = 0;
...
static int Isp_Drv_R2k_Wrap_SetDmaErrDecCfg(struct k510_isp_device *isp,ISP_WRAP_DMA_ERR_DEC_CFG_S *pstDmaErrDec)
{
	union U_ISP_WRAP_DMA_CH0_ERR_DEC_CFG stDmaCfg0;	
	stDmaCfg0.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH1_ERR_DEC_CFG stDmaCfg1;
	stDmaCfg1.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH2_ERR_DEC_CFG stDmaCfg2;
	stDmaCfg2.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH3_ERR_DEC_CFG stDmaCfg3;
	stDmaCfg3.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH4_ERR_DEC_CFG stDmaCfg4;
	stDmaCfg4.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH5_ERR_DEC_CFG stDmaCfg5;
	stDmaCfg5.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH6_ERR_DEC_CFG stDmaCfg6;
	stDmaCfg6.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH7_ERR_DEC_CFG stDmaCfg7;
	stDmaCfg7.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH8_ERR_DEC_CFG stDmaCfg8;
	stDmaCfg8.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH9_ERR_DEC_CFG stDmaCfg9;
	stDmaCfg9.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH10_ERR_DEC_CFG stDmaCfg10;	
	stDmaCfg10.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH11_ERR_DEC_CFG stDmaCfg11;
	stDmaCfg11.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH12_ERR_DEC_CFG stDmaCfg12;
	stDmaCfg12.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH13_ERR_DEC_CFG stDmaCfg13;
	stDmaCfg13.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH14_ERR_DEC_CFG stDmaCfg14;
	stDmaCfg14.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH15_ERR_DEC_CFG stDmaCfg15;
	stDmaCfg15.u32 = 0;
...
static int Isp_Drv_R2k_Wrap_SetDmaErrStatus(struct k510_isp_device *isp,ISP_WRAP_DMA_ERR_STATUS_S *pstErrStatus)
{

	union U_ISP_WRAP_DMA_CH0_ERR_STATUS stDmaCfg0;	
	stDmaCfg0.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH1_ERR_STATUS stDmaCfg1;
	stDmaCfg1.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH2_ERR_STATUS stDmaCfg2;
	stDmaCfg2.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH3_ERR_STATUS stDmaCfg3;	
	stDmaCfg3.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH4_ERR_STATUS stDmaCfg4;
	stDmaCfg4.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH5_ERR_STATUS stDmaCfg5;
	stDmaCfg5.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH6_ERR_STATUS stDmaCfg6;
	stDmaCfg6.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH7_ERR_STATUS stDmaCfg7;
	stDmaCfg7.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH8_ERR_STATUS stDmaCfg8;
	stDmaCfg8.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH9_ERR_STATUS stDmaCfg9;
	stDmaCfg9.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH10_ERR_STATUS stDmaCfg10;
	stDmaCfg10.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH11_ERR_STATUS stDmaCfg11;
	stDmaCfg11.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH12_ERR_STATUS stDmaCfg12;
	stDmaCfg12.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH13_ERR_STATUS stDmaCfg13;
	stDmaCfg13.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH14_ERR_STATUS stDmaCfg14;
	stDmaCfg14.u32 = 0;
	...
	union U_ISP_WRAP_DMA_CH15_ERR_STATUS stDmaCfg15;
	stDmaCfg15.u32 = 0;
...
*buf
*/
int Isp_Drv_R2k_Wrap_SetwdrBuf(struct k510_isp_device *isp,ISP_WRAP_WDR_BUF_S *pstWdrBuf)
{	

    union U_ISP_WRAP_WDR_LONG_BUF_BASE stWdrBuf;
	stWdrBuf.u32 = 0x00F80000;
	isp_reg_writel(isp,stWdrBuf.u32,ISP_IOMEM_R2K_WRAP,ISP_WRAP_WDR_LONG_BUF_BASE);
	//0x21
    union U_ISP_WRAP_WDR_LONG_SIZE_CFG stWdrSize;
...
int Isp_Drv_R2k_Wrap_Set3dnrBuf(struct k510_isp_device *isp,ISP_WRAP_3DNR_BUF_S *pst3dnrBuf)
{
	union U_ISP_WRAP_3DNR_Y_BUF_BASE stYbufBase;
	stYbufBase.u32 = 0;
	...
	union U_ISP_WRAP_3DNR_UV_BUF_BASE stUvbufBase;
	stUvbufBase.u32 = 0;
	...
	union U_ISP_WRAP_3DNR_STRIDE stStride;
	stStride.u32 = 0;
...
{	
	union U_ISP_WRAP_LDC_Y_BUF_BASE stYbufBase;
	stYbufBase.u32 = 0;
	...
	union U_ISP_WRAP_LDC_UV_BUF_BASE stUvbufBase;
	stUvbufBase.u32 = 0;
	...
	union U_ISP_WRAP_LDC_STRIDE stStride;	
	stStride.u32 = 0;
...
int Isp_Drv_R2k_Wrap_SetMainBuf(struct k510_isp_device *isp,ISP_WRAP_MAIN_BUF_S *pstMainBuf)
{
	...
	union U_ISP_WRAP_MAIN_Y_BUF0_BASE stYbufBase0;
	stYbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_MAIN_Y_BUF1_BASE stYbufBase1;		
	stYbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_MAIN_UV_BUF0_BASE stUvbufBase0;
	stUvbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_MAIN_UV_BUF1_BASE stUvbufBase1;
	stUvbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_MAIN_STRIDE stStride;
	stStride.u32 = 0;
...
{	
	...
	union U_ISP_WRAP_DS0_Y_BUF0_BASE stYbufBase0;
	stYbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_DS0_Y_BUF1_BASE stYbufBase1;
	stYbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_DS0_UV_BUF0_BASE stUvbufBase0;
	stUvbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_DS0_UV_BUF1_BASE stUvbufBase1;
	stUvbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_DS0_STRIDE stStride;	
	stStride.u32 = 0;
...
int Isp_Drv_R2k_Wrap_SetDs1Buf(struct k510_isp_device *isp,ISP_WRAP_DS1_BUF_S *pstDs1Buf)
{
	...
	union U_ISP_WRAP_DS1_Y_BUF0_BASE stYbufBase0;
	stYbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_DS1_Y_BUF1_BASE stYbufBase1;
	stYbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_DS1_UV_BUF0_BASE stUvbufBase0;
	stUvbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_DS1_UV_BUF1_BASE stUvbufBase1;
	stUvbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_DS1_STRIDE stStride;	
	stStride.u32 = 0;
...
int Isp_Drv_R2k_Wrap_SetDs2Buf(struct k510_isp_device *isp,ISP_WRAP_DS2_BUF_S *pstDs2Buf)
{
	...
	union U_ISP_WRAP_DS2_R_BUF0_BASE stRbufBase0;
	stRbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_DS2_R_BUF1_BASE stRbufBase1;
	stRbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_DS2_G_BUF0_BASE stGbufBase0;
	stGbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_DS2_G_BUF1_BASE stGbufBase1;
	stGbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_DS2_B_BUF0_BASE stBbufBase0;
	stBbufBase0.u32 = 0;
	...
	union U_ISP_WRAP_DS2_B_BUF1_BASE stBbufBase1;
	stBbufBase1.u32 = 0;
	...
	union U_ISP_WRAP_DS2_STRIDE0 stStride0;	
	stStride0.u32 = 0;
	...
	union U_ISP_WRAP_DS2_STRIDE1 stStride1;
	stStride1.u32 = 0;
...
{
	union U_ISP_WRAP_AXI_CTL stData;
	stData.u32 = 0;
...
int Isp_Drv_R2k_Wrap_SetConfigdoneCtl(struct k510_isp_device *isp,ISP_WRAP_CONFIG_DONE_S *pstConfigDone)
{
    ...
    union U_ISP_WRAP_CONFIG_DONE stData;
...
unsigned int Isp_Drv_R2k_Wrap_GetRevison(struct k510_isp_device *isp)
{
	...
	unsigned int verison = isp_reg_readl(isp,ISP_IOMEM_R2K_WRAP,ISP_VERSION);
	return verison;
}
/*
*INT
...
int Isp_Drv_R2k_Wrap_SetCoreIntCtlMask(struct k510_isp_device *isp,ISP_WRAP_CORE_INT_CTL_S *pstCoreIntCtl)
{
	...
	union U_ISP_WRAP_CORE_INT_CTL stData;
...
int Isp_Drv_R2k_Wrap_SetDmaWRIntMask0(struct k510_isp_device *isp,ISP_WRAP_DMA_WR_INT_MASK0_S *pstDmaWRIntMask0)
{
	...
	union U_ISP_WRAP_DMA_WR_INT_MASK0 stData;
	stData.u32 = 0xFFFFFFFF;
...
int Isp_Drv_R2k_Wrap_SetDmaWRIntMask1(struct k510_isp_device *isp,ISP_WRAP_DMA_WR_INT_MASK1_S *pstDmaWRIntMask1)
{
	...
	union U_ISP_WRAP_DMA_WR_INT_MASK1 stData;
	stData.u32 = 0xFFFFFFFF;
...
int Isp_Drv_R2k_Wrap_SetDmaRDIntMask0(struct k510_isp_device *isp,ISP_WRAP_DMA_RD_INT_MASK0_S *pstDmaRDIntMask0)
{
	...
	union U_ISP_WRAP_DMA_RD_INT_MASK0 stData;
	stData.u32 = 0xFFFFFFFF;
...
static int Isp_Drv_R2k_Wrap_SetIntMask(struct k510_isp_device *isp,ISP_WRAP_INT_CTL_S *stIntCtl)
{
...
*wdr
*/
int Isp_Drv_R2k_Wrap_SetWdr(struct k510_isp_device *isp,ISP_WRAP_WDR_ATTR_S *pstWdrAttr)
{
...
*3dnr
*/
int Isp_Drv_R2k_Wrap_Set3Dnr(struct k510_isp_device *isp,ISP_WRAP_3DNR_ATTR_S *pst3DnrAttr)
{
