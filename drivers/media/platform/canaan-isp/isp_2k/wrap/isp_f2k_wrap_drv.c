...
static int Isp_Drv_F2k_Wrap_SetModeCtl_Wdr(struct k510_isp_device *isp,ISP_WRAP_WDR_MODE_CTL_S *pstWdrModeCtl)
{
...
int Isp_Drv_F2k_Wrap_SetModeCtl_3dnr_fbcd_en(struct k510_isp_device *isp,unsigned int nr3d_fbcd_en)
{
...
static void Isp_Drv_F2k_Wrap_Set3DnrClkCtl(struct k510_isp_device *isp,signed int clk_3dnr_en)
{
...
static void Isp_Drv_F2k_Wrap_SetWdrClkCtl(struct k510_isp_device *isp,ISP_WRAP_WDR_CLK_CTL_S *pstWdrClkCtl)
{
...
static void Isp_Drv_F2k_Wrap_SetLdcClkCtl(struct k510_isp_device *isp,unsigned int ldc_clk_en)
{
...
static void Isp_Drv_F2k_Wrap_SetMainClkCtl(struct k510_isp_device *isp,unsigned int main_out_clk_en)
{
...
static void Isp_Drv_F2k_Wrap_SetDs0ClkCtl(struct k510_isp_device *isp,ISP_WRAP_DS0_CLK_CTL_S *pstDs0ClkCtl)
{
...
static void Isp_Drv_F2k_Wrap_SetDs1ClkCtl(struct k510_isp_device *isp,ISP_WRAP_DS1_CLK_CTL_S *pstDs1ClkCtl)
{
...
static void Isp_Drv_F2k_Wrap_SetDs2ClkCtl(struct k510_isp_device *isp,ISP_WRAP_DS2_CLK_CTL_S *pstDs2ClkCtl)
{
...
*DMA EN
*/
static void Isp_Drv_F2k_Wrap_Set3dnrDmaEnCtl(struct k510_isp_device *isp,unsigned int pipe_3dnr_dma_en)
{	
...
static void Isp_Drv_F2k_Wrap_SetWdrDmaEnCtl(struct k510_isp_device *isp,ISP_WRAP_WDR_DMA_EN_CTL_S *pstWdrDmaEn)
{
...
static void Isp_Drv_F2k_Wrap_SetLdcDmaEnCtl(struct k510_isp_device *isp,unsigned int ldc_dma_en)
{
...
static void Isp_Drv_F2k_Wrap_SetMainDmaEnCtl(struct k510_isp_device *isp,unsigned int main_out_dma_en)
{
...
static void Isp_Drv_F2k_Wrap_SetDs0DmaEnCtl(struct k510_isp_device *isp,ISP_WRAP_DS0_DMA_EN_CTL_S *pstDs0DMAEnCtl)
{
...
static void Isp_Drv_F2k_Wrap_SetDs1DmaEnCtl(struct k510_isp_device *isp,ISP_WRAP_DS1_DMA_EN_CTL_S *pstDs1DMAEnCtl)
{
...
static void Isp_Drv_F2k_Wrap_SetDs2DmaEnCtl(struct k510_isp_device *isp,ISP_WRAP_DS2_DMA_EN_CTL_S *pstDs2DMAEnCtl)
{	
...
*3dnr format
*/
static int Isp_Drv_F2k_Wrap_Set3DnrFormatCtl(struct k510_isp_device *isp,ISP_WRAP_3DNR_PIXEL_FORMAT_CTL_S *pst3DnrFormat)
{
...
*WDR
*/
static int Isp_Drv_F2k_Wrap_SetWdrFormatCtl(struct k510_isp_device *isp,ISP_WRAP_WDR_PIXEL_FORMAT_CTL_S *pstWdrFormat)
{
...
*DS pixel format
*/
static int Isp_Drv_F2k_Wrap_SetMainPixelFormatCtl(struct k510_isp_device *isp,ISP_WRAP_MAIN_PIXEL_FORMAT_CTL_S *pstMainPixelFormat)
{
...
static int Isp_Drv_F2k_Wrap_SetDs0PixelFormatCtl(struct k510_isp_device *isp,ISP_WRAP_DS0_PIXEL_FORMAT_CTL_S *pstDs0PixelFormat)
{
...
static int Isp_Drv_F2k_Wrap_SetDs1PixelFormatCtl(struct k510_isp_device *isp,ISP_WRAP_DS1_PIXEL_FORMAT_CTL_S *pstDs1PixelFormat)
{
...
static int Isp_Drv_F2k_Wrap_SetDs2PixelFormatCtl(struct k510_isp_device *isp,ISP_WRAP_DS2_PIXEL_FORMAT_CTL_S *pstDs2PixelFormat)
{
...
*DS out size
*/
static int Isp_Drv_F2k_Wrap_SetMainOutSize(struct k510_isp_device *isp,ISP_WRAP_MAIN_OUT_SIZE_S *stMainOutSize)
{
...
static int Isp_Drv_F2k_Wrap_SetDs0OutSize(struct k510_isp_device *isp,ISP_WRAP_DS0_OUT_SIZE_S *stDs0OutSize)
{
...
static int Isp_Drv_F2k_Wrap_SetDs1OutSize(struct k510_isp_device *isp,ISP_WRAP_DS1_OUT_SIZE_S *stDs1OutSize)
{
...
static int Isp_Drv_F2k_Wrap_SetDs2OutSize(struct k510_isp_device *isp,ISP_WRAP_DS2_OUT_SIZE_S *stDs2OutSize)
{
...
*DMA
 */
static int Isp_Drv_F2k_Wrap_SetDmaMode(struct k510_isp_device *isp,ISP_WRAP_DMA_MODE_S *pstDmaMode)
{
...
static int Isp_Drv_F2k_Wrap_SetDmaCfgMode(struct k510_isp_device *isp,ISP_WRAP_DMA_CFG_S *pstDmaCfg)
{
...
static int Isp_Drv_F2k_Wrap_SetDmaErrDecCfg(struct k510_isp_device *isp,ISP_WRAP_DMA_ERR_DEC_CFG_S *pstDmaErrDec)
{
...
static int Isp_Drv_F2k_Wrap_SetDmaErrStatus(struct k510_isp_device *isp,ISP_WRAP_DMA_ERR_STATUS_S *pstErrStatus)
{
...
unsigned int Isp_Drv_F2k_Wrap_GetRevison(struct k510_isp_device *isp)
{
	...
	unsigned int verison = isp_reg_readl(isp,ISP_IOMEM_F2K_WRAP,ISP_VERSION);
	return verison;
}
/*
*INT
...
static int Isp_Drv_F2k_Wrap_SetIntMask(struct k510_isp_device *isp,ISP_WRAP_INT_CTL_S *stIntCtl)
{
