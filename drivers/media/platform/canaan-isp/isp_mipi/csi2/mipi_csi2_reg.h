...
*/
#ifndef _MIPI_CSI2_REG_H_
#define _MIPI_CSI2_REG_H_

union U_CSI_RX_STREAM_DEVICE_CFG
{
...
union U_CSI_RX_STREAM_STATIC_CFG
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_CFG_ADDR
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_ERR_BYPASS_CFG
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_MONITOR_IRQS
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_MONITOR_IRQS_MASK_CFG
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_INFO_IRQS
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_INFO_IRQS_MASK_CFG
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_ERROR_IRQS
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_ERROR_IRQS_MASK_CFG
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_DPHY_LANE_CONTROL
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_DPHY_LANE_CONFIG
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_DPHY_ERR_STATUS_IRQ
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_DPHY_ERR_IRQ_MASK
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_INTEGRATION_DEBUG
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_DATA_CFG
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_MONITOR_CTRL
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_MONITOR_FRAME
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_MONITOR_LB
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_FCC_CTRL
{
    /* Define the struct bits */
    struct
    {
...
union U_CSI_RX_STREAM_FCC_FILL_LVL
{
    /* Define the struct bits */
    struct
    {
...
//stream 3
#define   CSI_RX_STREAM3_CTRL                   (0x0400)  
#define   CSI_RX_STREAM3_STATUS                 (0x0404)
#define   CSI_RX_STREAM3_DATA_CFG               (0x0408)
#define   CSI_RX_STREAM3_CFG                    (0x040C)
#define   CSI_RX_STREAM3_MONITOR_CTRL           (0x0410)
#define   CSI_RX_STREAM3_MONITOR_FRAME          (0x0414)
#define   CSI_RX_STREAM3_MONITOR_LB             (0x0418)
#define   CSI_RX_STREAM3_TIMER                  (0x041C)
#define   CSI_RX_STREAM3_FCC_CFG                (0x0420)
#define   CSI_RX_STREAM3_FCC_CTRL               (0x0424)
#define   CSI_RX_STREAM3_FCC_FILL_LVL           (0x0328)
#endif /*_MIPI_CSI2_REG_H_*/