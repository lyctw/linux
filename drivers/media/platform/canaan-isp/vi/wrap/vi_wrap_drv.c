...
#include "../vi.h"
#include "../vi_com.h"
#include "vi_wrap_drv.h"
#include "vi_wrap_reg.h"
...
{
	union U_VI_WRAP_SWRST_CTL stData;
	stData.udata = 0;
	...
	//stData.udata =0x3ff;
	//dev_info(isp->dev,"%s:isp0x%x,VI_WRAP_SWRST_CTL = 0x%x\n",__func__,isp,stData.udata);
...
int VI_DRV_WRAP_SetCtlMode(struct k510_isp_device *isp,VI_WRAP_CSI_MODE_CTL_S *pstCsiModeCtl)
{
	...
	union U_VI_WRAP_CSI_MODE_CTL stData;	
	stData.udata = 0;
...
int VI_DRV_WRAP_SetIspChSel(struct k510_isp_device *isp,VI_WRAP_ISP_CH_SEL_S *pstIspChSel)
{
	...
	union U_VI_WRAP_ISP_CH_SEL stData;
	stData.udata = 0;
...
int VI_DRV_WRAP_SetClockCtl(struct k510_isp_device *isp,VI_WRAP_CLOCK_CTL_S *pstClkCtl)
{
	...
	union U_VI_WRAP_CLOCK_CTL stData;	
	stData.udata = 0;
...
int VI_DRV_WRAP_SetDmaAttr(struct k510_isp_device *isp,VI_WRAP_DMA_ATTR_S *pstDmaAttr)
{
	...
	union U_VI_WRAP_DMA_ARB_MODE			stDmaArbMode;
	...
	union U_VI_WRAP_DMA_WR_WEIGHT_0		stWrChWeight0;
	...
	union U_VI_WRAP_DMA_WR_WEIGHT_1		stWrChWeight1;
	...
	union U_VI_WRAP_DMA_RD_WEIGHT_0		stRdChWeight0;
	...
	union U_VI_WRAP_DMA_RD_WEIGHT_1		stRdChWeight1;
	...
	union U_VI_WRAP_DMA_WR_PRIORITY		stWrChPriority;
	...
	union U_VI_WRAP_DMA_RD_PRIORITY 		stRdChPriority;
	...
	union U_VI_WRAP_DMA_WR_CH_ID			stWriteChId;
	stWriteChId.udata = 0;
	...
	union U_VI_WRAP_DMA_RD_CH_ID			stReadChId;
	stReadChId.udata = 0;
...
{	
	...
	union U_VI_WARP_INT_CTL			stIntCtl;
...
{	
	...
	union U_VI_WRAP_CONFIG_CTL stData;	
