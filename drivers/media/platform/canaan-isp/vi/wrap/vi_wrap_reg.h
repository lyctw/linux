...
union U_VI_WRAP_DMA_WR_WEIGHT_0
{
    /* Define the struct bits */
    struct
    {
...
union U_VI_WRAP_DMA_WR_WEIGHT_1
{
    /* Define the struct bits */
    struct
    {
...
union U_VI_WRAP_DMA_RD_WEIGHT_0
{
    /* Define the struct bits */
    struct
    {
...
union U_VI_WRAP_DMA_RD_WEIGHT_1
{
    /* Define the struct bits */
    struct
    {
...
union U_VI_WRAP_DMA_WR_PRIORITY
{
    /* Define the struct bits */
    struct
    {
...
union U_VI_WRAP_DMA_RD_PRIORITY
{
    /* Define the struct bits */
    struct
    {
